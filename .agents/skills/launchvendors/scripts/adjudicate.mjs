...
//
// usage:
//   node --env-file=.env.local .agents/skills/launchvendors/scripts/adjudicate.mjs <workdir> [--type music] [--region "Denver, CO"] [--names]
//   node --env-file=.env.local .agents/skills/launchvendors/scripts/adjudicate.mjs <workdir> [--type music] [--region "Denver, CO"] \
