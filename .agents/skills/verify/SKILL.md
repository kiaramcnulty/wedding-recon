---
name: verify
description: Run and drive Wedding Recon in an environment without Supabase credentials (e.g. Codex on the web) by pointing the app at a fake PostgREST backend and driving it with Playwright + the preinstalled Chromium.
---
