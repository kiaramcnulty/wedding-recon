...
// usage: node --env-file=.env.local .agents/skills/enrichvendors/scripts/harvest.mjs <workdir> --region CO [--type photographer] [--venues "Name 1;Name 2"] [--limit N] [--refresh]
