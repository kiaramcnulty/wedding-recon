...
**Deferred decision — Batch-API drafting:** moving `/enrichvendors` draft workers onto the metered Anthropic Batch API (off the Claude subscription, ~$1–1.50 per 300-vendor run) is fully specced in `docs/anthropic-batch-drafting.md`. Deferred by Kiara 2026-07-10 pending a billing decision; a fresh session can build it from that doc alone.
