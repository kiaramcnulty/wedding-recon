...
- `notes`: ONE line (no embedded newlines), first person, in the assigned bot's voice per the voice cards. **2-5 sentences. Rich dossier → up to ~90 words. Thin or quote-only venue → 25-50 words and stop; don't pad.** Cut filler words; keep concrete facts: capacity, inclusions, catering policy, a review specific, logistics quirks. Attribute borrowed experiences ("a review mentions...", "a bride on reddit said..."); never first person for things the bot didn't do. Include warts when sources have them.
