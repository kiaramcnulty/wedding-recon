...
honest no-price entry per common/entry-rules-core.md (plain varied wording, never the
retired "Quote only"). If the searches DID turn up a number, however soft the source, that
number leads the headline instead.
